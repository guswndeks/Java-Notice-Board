...
<body style="text-align:center; margin:0 auto; display:inline; padding-top:100px;">
    <form:form modelAttribute="searchVO" id="listForm" name="listForm" method="post">
        ...
        <div id="content_pop" style="position:absolute;">
        	
        	<!-- 타이틀 -->
        	<div id="title" style="position:absolute; left:250px;">
        		<ul>
        	...
        	<!-- List -->
        <div >
        	<div id="table" style="position:absolute; top:30px;" >
        		<table width="50%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블" >
        			<caption style="visibility:hidden">카테고리ID, Title, Use-Y/N, Contents, Writer</caption>
        	...
        	<!-- egovSampleRegister.jsp 들어갈 자리-->
        	<div id="ESR" style=" height:80%; position:absolute; left:430px; top:41px; border:solid; border-color:red;">
        	
        	<jsp:include page="egovSampleRegister.jsp" flush="true"/>
        	
        	</div>
        	
        	<!-- /List -->
        	<div id="paging" style="position:absolute; top:930px;">
        	...
        	<div id="sysbtn" style="position:absolute; top:930px; left:650px;">
        	  <ul>
        	      <li>
        	          <span class="btn_blue_l">
